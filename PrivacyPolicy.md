...
This App includes the Google Mobile Ads SDK. 

### Google AdMob Partners Disclosure
To provide transparency and comply with Google's platform policies, please note that Google uses the end-user data and IP addresses collected via this App to provide personalization, ad delivery, and IP-based measurement solutions. For detailed information on how Google processes, uses, and safeguards your data, please review **[How Google uses information from sites or apps that use our services](https://policies.google.com/technologies/partner-sites)**.
...
| Data Type | How the Google Mobile Ads SDK uses it |
| :--- | :--- |
| **IP address** | Collects the device's IP address, which may be used to estimate the general location of a device, as well as for network-based data processing and IP-based personalization/measurement solutions. |
