...
* ডাউনলোড করা জিপ ফাইলটি খুলতে সেটির ওপর ডাবল ক্লিক করুন, কনটেক্সট মেনু খুলতে `platform-tools` ফোল্ডারের ওপর রাইট ক্লিক করুন এবং তারপর _Services_ > _New Terminal at Folder_-এ ক্লিক করুন।
...
*যদি প্লে স্টোর সংস্করণটি আপনার ডিভাইসে কাজ না করে, তবে আপনি এর পরিবর্তে এই [Shizuku fork](https://github.com/thedjchi/Shizuku/releases) ব্যবহার করতে পারেন।
