...
* 雙擊下載的 zip 檔案將其打開，右鍵單擊 `platform-tools` 資料夾以打開上下文菜單，然後單擊「服務」 > 「在資料夾中新建終端機」。
...
*如果 Play 商店版本在您的設備上不起作用，您可以改用此 [Shizuku 分支](https://github.com/thedjchi/Shizuku/releases)。
