...
* ڈاؤن لوڈ کردہ زپ فائل کو کھولنے کے لیے ڈبل کلک کریں، سیاق و سباق کا مینو کھولنے کے لیے `platform-tools` فولڈر پر دائیں کلک کریں اور پھر _Services_ > _New Terminal at Folder_ پر کلک کریں۔
...
*اگر Play Store ورژن آپ کے آلے پر کام نہیں کرتا ہے، تو آپ اس کے بجائے یہ [Shizuku fork](https://github.com/thedjchi/Shizuku/releases) استعمال کر سکتے ہیں۔
