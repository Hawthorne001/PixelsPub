...
ਪੀਸੀ (PC) ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਇਜਾਜ਼ਤ ਦੇਣਾ:
----------------------
...
ਪੀਸੀ ਦੀ ਵਰਤੋਂ ਕੀਤੇ ਬਿਨਾਂ ਇਜਾਜ਼ਤ ਦੇਣਾ (Shizuku ਦੀ ਵਰਤੋਂ ਕਰਕੇ):
----------------------
<details>

### ਵਿਕਲਪ 1: ਤੁਸੀਂ [Shizuku](https://play.google.com/store/apps/details?id=moe.shizuku.privileged.api)* ਇੰਸਟਾਲ ਕਰ ਸਕਦੇ ਹੋ

ਅਤੇ ਦਿੱਤੀਆਂ ਹదాਇਤਾਂ ਦੀ ਪਾਲਣਾ ਕਰਕੇ ਇਸਨੂੰ ਸਰਗਰਮ ਕਰ ਸਕਦੇ ਹੋ।  
ਇਸ ਤੋਂ ਬਾਅด, _Pixels_ ਐਪ 'ਤੇ ਵਾਪਸ ਜਾਓ ਅਤੇ ਰੈਜ਼ੋਲਿਊਸ਼ਨ ਲਾਗੂ ਕਰਕੇ ਇਸਨੂੰ ਇਜਾਜ਼ਤ ਦਿਓ।

*ਜੇਕਰ ਪਲੇ ਸਟੋਰ ਵਰਜ਼ਨ ਤੁਹਾਡੀ ਡਿਵਾਈਸ 'ਤੇ ਕੰਮ ਨਹੀਂ ਕਰਦਾ ਹੈ, ਤਾਂ ਤੁਸੀਂ ਇਸ ਦੀ ਬਜਾਏ ਇਸ [Shizuku fork](https://github.com/thedjchi/Shizuku/releases) ਦੀ ਵਰਤੋਂ ਕਰ ਸਕਦੇ ਹੋ।
